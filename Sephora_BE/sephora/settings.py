"""
Django settings for sephora project.
...
SECRET_KEY = 'django-insecure-)#r3-rc=0l_tnt$db2d5myhovh7(@(4lkze(7y7r6s5j6h#m)e'
...
MIDDLEWARE = [
    ...
    'sephora.middleware.DisableCSRFForAPI',
    ...
    "sephora.firebase_auth.FirebaseAuthenticationMiddleware",
